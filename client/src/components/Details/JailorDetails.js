...
import './Details.css'
import '../AddOthers/AddOthers.css'
import Axios from 'axios'

function JailorDetails() {
    ...
    useEffect(() => {
        Axios.get('http://localhost:5000/jailor',{
    ...
    const onButtonClick=(e)=>{
        e.preventDefault()
        console.log(values)
        const filterResult=searchApiData.filter(item=>item.j_id.includes(values))
...
<div className='addingothers'>
        <div className='boxinside'>
            <div>
                <h1 className='title1'>Jailor Details</h1>
            </div>
            <div>
